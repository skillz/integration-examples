...
namespace UnityEditor.SKZXCodeEditor
{
	public class XCBuildConfiguration : PBXObject
	{
		...
		protected const string CLANG_ENABLE_CPP_STATIC_DESTRUCTORS_KEY = "CLANG_ENABLE_CPP_STATIC_DESTRUCTORS";
		...
		public bool ClangEnableCppStaticDestructors (string value)
		{
			if (!ContainsKey (BUILDSETTINGS_KEY))
				this.Add (BUILDSETTINGS_KEY, new PBXDictionary ());

			((PBXDictionary)_data [BUILDSETTINGS_KEY])[CLANG_ENABLE_CPP_STATIC_DESTRUCTORS_KEY] = value;
			return true;
		}
